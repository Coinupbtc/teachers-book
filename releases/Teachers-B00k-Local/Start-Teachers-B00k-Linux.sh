...
(xdg-open http://127.0.0.1:8010 >/dev/null 2>&1 || true) &
printf '\nTeachers B00k is running locally. Keep this Terminal open while using it.\n'
printf 'Your data is stored only on this computer in backend/gradebook.db.\n\n'
